...
// +kubebuilder:rbac:groups=cloudcredential.uccp.io,resources=credentialsrequests;credentialsrequests/status;credentialsrequests/finalizers,verbs=get;list;watch;create;update;patch;delete
...
// +kubebuilder:rbac:groups=config.uccp.io,resources=clusterversions,verbs=get;list;watch
// +kubebuilder:rbac:groups=config.uccp.io,resources=infrastructures;dnses,verbs=get;list;watch
// +kubebuilder:rbac:groups=config.uccp.io,resources=clusteroperators;clusteroperators/status,verbs=create;get;update;list;watch
