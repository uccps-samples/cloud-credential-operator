...
import (
	...
	mintergcp "github.com/uccps-samples/cloud-credential-operator/pkg/gcp"
	...
	gcpconst "github.com/uccps-samples/cloud-credential-operator/pkg/operator/secretannotator/gcp"
	...
	tests := []struct {
		...
		},
		{
			...
			existing: []runtime.Object{
				...
				testGCPCredsSecret("uccp-cloud-credential-operator", "cloud-credential-operator-gcp-ro-creds", testReadOnlyGCPAuth),
			},
			mockReadGCPClient: func(mockCtrl *gomock.Controller) *mockgcp.MockClient {
				mockGCPClient := mockgcp.NewMockClient(mockCtrl)
