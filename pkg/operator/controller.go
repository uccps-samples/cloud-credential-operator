...
import (
	awsactuator "github.com/uccps-samples/cloud-credential-operator/pkg/aws/actuator"
	"github.com/uccps-samples/cloud-credential-operator/pkg/azure"
	gcpactuator "github.com/uccps-samples/cloud-credential-operator/pkg/gcp/actuator"
	"github.com/uccps-samples/cloud-credential-operator/pkg/kubevirt"
	"github.com/uccps-samples/cloud-credential-operator/pkg/openstack"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/awspodidentity"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/cleanup"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/credentialsrequest"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/credentialsrequest/actuator"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/loglevel"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/metrics"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/platform"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/secretannotator"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/status"
	"github.com/uccps-samples/cloud-credential-operator/pkg/ovirt"
	"github.com/uccps-samples/cloud-credential-operator/pkg/util"
	vsphereactuator "github.com/uccps-samples/cloud-credential-operator/pkg/vsphere/actuator"
...
func AddToManager(m manager.Manager, explicitKubeconfig string) error {
	...
	for _, f := range AddToManagerWithActuatorFuncs {
		...
		// https://github.com/uccps-samples/api/blob/master/config/v1/types_infrastructure.go#L11
		var err error
