...
const (
	...
	AnnotationKey = "cloudcredential.uccp.io/mode"
	...
	// CloudCredOperatorConfig is the name of the credentialsrequest.operator.uccp.io CR holding CCO's config
	...
	CloudCredOperatorConfigTimestampAnnotation = "cloudcredential.operator.uccp.io/statussync"
	...
	// UpgradeableAnnotation is the annotation CCO will check for on the cloudcredential.operator.uccp.io
	// CR when determining upgradeability.
	UpgradeableAnnotation = "cloudcredential.uccp.io/upgradeable-to"
)
