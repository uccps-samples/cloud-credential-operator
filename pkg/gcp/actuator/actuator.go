...
import (
	...
	ccgcp "github.com/uccps-samples/cloud-credential-operator/pkg/gcp"
	...
	gcputils "github.com/uccps-samples/cloud-credential-operator/pkg/operator/utils/gcp"
)

const (
	roGCPCredsSecretNamespace = "uccp-cloud-credential-operator"
...
// for CCO, which are expected to live in uccp-cloud-credential-perator/cloud-credential-operator-gcp-ro-creds.
