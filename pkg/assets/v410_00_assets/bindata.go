  ...
  template:
    ...
    spec:
      ...
      - name: pod-identity-webhook
        ...
        - --annotation-prefix=eks.amazonaws.com # TODO: use uccp.io based prefix
...
metadata:
  ...
  annotations:
    ...
    service.beta.uccp.io/serving-cert-secret-name: pod-identity-webhook
spec:
  ports:
  - port: 443
    targetPort: 6443
