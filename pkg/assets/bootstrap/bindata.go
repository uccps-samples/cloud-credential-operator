...
metadata:
  annotations:
    include.release.uccp.io/ibm-cloud-managed: "true"
    include.release.uccp.io/self-managed-high-availability: "true"
  name: credentialsrequests.cloudcredential.uccp.io
spec:
  group: cloudcredential.uccp.io
  names:
...
metadata:
  annotations:
    api-approved.uccp.io: https://github.com/uccps-samples/api/pull/692
    include.release.uccp.io/self-managed-high-availability: "true"
    include.release.uccp.io/single-node-developer: "true"
  name: cloudcredentials.operator.uccp.io
spec:
...
metadata:
  ...
  labels:
    ...
    uccp.io/cluster-monitoring: "true"
