...
import (
	...
	assets "github.com/uccps-samples/cloud-credential-operator/pkg/assets/bootstrap"
...
var (
	operatorConfigTemplate = template.Must(template.New("operatorConfig").Parse(`apiVersion: operator.uccp.io/v1
