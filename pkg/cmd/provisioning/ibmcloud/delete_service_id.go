...
import (
	...
	"github.com/uccps-samples/cloud-credential-operator/pkg/ibmcloud"
)
...
func NewDeleteServiceIDCmd() *cobra.Command {
	...
	deleteServiceIDCmd.PersistentFlags().StringVar(&Options.CredRequestDir, "credentials-requests-dir", "", "Directory containing files of CredentialsRequests to delete IAM Roles for (can be created by running 'oc adm release extract --credentials-requests --cloud=ibmcloud' against an Uccp release image)")
