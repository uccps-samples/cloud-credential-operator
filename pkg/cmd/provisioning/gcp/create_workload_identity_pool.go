...
var (
	...
	createdByCcoctl = "Created By Uccp ccoctl"
	...
	createIdentityPoolCmd = "gcloud iam workload-identity-pools create %s --location=global --description=\"Created by Uccp ccoctl\" --display-name=%s"
)
