...
const (
	...
	FinalizerDeprovision string = "cloudcredential.uccp.io/deprovision"
	...
	AnnotationCredentialsRequest string = "cloudcredential.uccp.io/credentials-request"
	...
	AnnotationAWSPolicyLastApplied string = "cloudcredential.uccp.io/aws-policy-last-applied"

	// CloudCredOperatorNamespace is the namespace where the credentials operator runs.
	CloudCredOperatorNamespace = "uccp-cloud-credential-operator"
)
