...
import (
	...
	awsannotator "github.com/uccps-samples/cloud-credential-operator/pkg/operator/secretannotator/aws"
	"github.com/uccps-samples/cloud-credential-operator/pkg/operator/utils"
	awsutils "github.com/uccps-samples/cloud-credential-operator/pkg/operator/utils/aws"
)

const (
	roAWSCredsSecretNamespace = "uccp-cloud-credential-operator"
...
// for cred minter, which are expected to live in uccp-cloud-credential-operator/cloud-credential-operator-iam-ro-creds.
